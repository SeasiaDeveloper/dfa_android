...
class LocationUpdateService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name: CharSequence = getString(com.ngo.R.string.app_name)
...
// do nothing. Otherwise, we make this service a foreground service.
    ...
    private fun getNotification(): Notification? {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .addAction(
                com.ngo.R.drawable.ic_launcher_foreground,
                getString(com.ngo.R.string.launch_activity),
                activityPendingIntent
            )
            .addAction(
                com.ngo.R.drawable.ic_close_black_24dp,
                getString(com.ngo.R.string.remove_location_updates),
            ...
            .setSmallIcon(com.ngo.R.mipmap.ic_launcher)
            .setTicker(text)
